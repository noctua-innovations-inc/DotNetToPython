...
class LlamaServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateText = channel.unary_unary(
                ...
                request_serializer=llama__service__pb2.TextRequest.SerializeToString,
                response_deserializer=llama__service__pb2.TextResponse.FromString,
...
def add_LlamaServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GenerateText': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=llama__service__pb2.TextRequest.FromString,
                    response_serializer=llama__service__pb2.TextResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'LlamaService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('LlamaService', rpc_method_handlers)
...
class LlamaService(object):
    ...
    def GenerateText(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/LlamaService/GenerateText',
            llama__service__pb2.TextRequest.SerializeToString,
            llama__service__pb2.TextResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
